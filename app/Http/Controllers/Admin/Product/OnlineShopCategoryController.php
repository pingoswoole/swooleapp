 ...
 * @created_at 00-00-00
 */
class OnlineShopCategoryController extends AdminController
{
        ...
        public function viewAll()
        {
            ...
            $this->render('product.onlineshop.category.all');
        }
        /**
         * 列表数据
         *
        ...
        public function addItem()
        {
            if($this->isPost()){
                ...
                return $this->render('product.onlineshop.category.add');
            }
        }
