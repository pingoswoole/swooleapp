...
class OnlineShopGoodsService extends Base
{
    ...
    protected $table = 'online_shop_goods';  
    /**
     * 条件查询列表所有
     *
     * @author pingo
      ...
      public function getPageList($page, $pageSize, array $where = []):array
      {
          ...
          try {
              ...
              $column = [
                ...
                'online_shop_goods.short_title',
                'online_shop_goods.price',
                'online_shop_goods.description',
                'online_shop_goods.thumb',
                'online_shop_goods.morepic',
                'online_shop_goods.is_hot',
                'online_shop_goods.is_recommend',
                'online_shop_goods.state',
                'online_shop_goods.created_at',
