    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <select name="grade" lay-verify="required">
            ...
            <option value="1" @if($grade === 1) selected @endif>VIP</option>
            <option value="2" @if($grade === 2) selected @endif>SVIP</option>
          </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="mobile" disabled  value="{{$mobile}}" autocomplete="off" placeholder="修改请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">昵称</label>
        <div class="layui-input-block">
            <input type="text" name="nickname"   value="{{$nickname}}" autocomplete="off" placeholder="修改请输入" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">密码</label>
        <div class="layui-input-block">
            <input type="text" name="newpwd"   value="" autocomplete="off" placeholder="修改请输入" class="layui-input">
