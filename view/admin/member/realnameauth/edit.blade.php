...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="short_title" lay-verify="required" value="{{$short_title}}" autocomplete="off" placeholder="请输入标题" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             @component('admin.template.form.multipic', ['name' => 'morepic', 'title' => '选择多图' , 'value' => json_decode($morepic, true)])
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(formBtn)', function (data) {
            ...
            $.post('/backend/product/onlineshop_goods/editItem/{{$id}}', data.field, function(result){
