...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#dataTable',
            url: '/backadmin/product/forum_ad/getPageList',
            ...
            cols: [[
                ...
                {field: 'title',  title: '图片', templet: function name(data) {
                    return '<img src="'+data.thumb+'" width="100px">'
                }},
        ...
        form.on('switch(stateSwitch)', function(obj){
            ...
            $.post('/backadmin/product/forum_ad/setItem/' + obj.value ,datajson,function(data){
                layer.msg(data.msg);
                if(data.code !== 0) {
        ...
        table.on('toolbar(dataTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['90%', '90%'],
                    content: '/backadmin/product/forum_ad/addItem',
                    end: function(){
                        table.reload('dataTable')
                    }
                });
        ...
        table.on('tool(dataTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['90%', '90%'],
                    content: '/backadmin/product/forum_ad/viewItem/'+data.id,
                    end: function(){
                        table.reload('dataTable')
                    }
                });
                ...
                layer.confirm('真的删除行么', function (index) {
                    $.post('/backadmin/product/forum_ad/delItem/'+data.id, {}, function(result){
