...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          ...
          {{--   @foreach ($resource_type as $key => $item)
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             @component('admin.template.form.image', ['name' => 'thumb', 'value' => '', 'title' => '选择缩略图'])
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
           @component('admin.template.form.uploadfile' , ['name' => 'resource_urls', 'value' => '', 'title' => '上传视频', 'return' => 'url'])@endcomponent
        </div>
      </div>
    {{-- <div class="layui-form-item">
        <label class="layui-form-label">多图展示【资源类型为image】</label>
        <div class="layui-input-block">
             @component('admin.template.form.multipic', ['name' => 'resource_urls', 'title' => '选择多图'])
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(formBtn)', function (data) {
            ...
            $.post('/backend/product/video_data/addItem', data.field, function(result){
