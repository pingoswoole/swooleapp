...
<form class="layui-form" action="">
   ...
   {{--  <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="link"   autocomplete="off" placeholder="请输入标题" class="layui-input">
        </div>
    </div> --}}
    <div class="layui-form-item">
        <label class="layui-form-label">图片</label>
        <div class="layui-input-block">
          @component('admin.template.form.image', ['name' => 'path', 'value' => '', 'title' => '上传图片', 'return' => 'url']) @endcomponent
        </div>
      </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form', 'layedit', 'laydate', 'tableSelect'], function () {
        ...
        tableSelect.render({
            ...
            checkedKey: 'id',
            table: {
                url: '/backend/product/forum_article/getPageList',
                cols: [[
                    { type: 'radio' },
                    { field: 'id', title: 'ID' },
        ...
        form.on('submit(formBtn)', function (data) {
            ...
            $.post('/backend/product/swiper_slider/addItem', data.field, function(result){
